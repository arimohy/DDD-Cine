...
public class NombreDeAutorActualizada extends DomainEvent {
    private final AutorId autorId;
    private final Nombre nombre;
    public NombreDeAutorActualizada(AutorId entityId, Nombre nombre) {
        super("sofka.pelicula.nombredeautoractualiada");
